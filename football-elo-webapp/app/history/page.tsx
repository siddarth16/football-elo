...
export default function HistoryPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-5xl font-black uppercase mb-2">ELO History</h1>
      ...
      <Card>
        <CardHeader>
          <CardTitle>{selectedTeam} - ELO Progression</CardTitle>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="border-4 border-black p-4">
              <div className="text-sm font-bold uppercase text-gray-600 mb-1">Starting ELO</div>
              <div className="text-3xl font-black">{teamMatches[0]?.elo.toFixed(0) || 'N/A'}</div>
            </div>
            <div className="border-4 border-black p-4">
              <div className="text-sm font-bold uppercase text-gray-600 mb-1">Current ELO</div>
              <div className="text-3xl font-black">{teamMatches[teamMatches.length - 1]?.elo.toFixed(0) || 'N/A'}</div>
            </div>
            <div className="border-4 border-black p-4">
              <div className="text-sm font-bold uppercase text-gray-600 mb-1">Change</div>
